...
public partial class Account_AllOrder : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSetTableAdapters.OrderHeadTableAdapter ds = new DataSetTableAdapters.OrderHeadTableAdapter();
        OrderRepeater.DataSource = ds.GetAllData();
